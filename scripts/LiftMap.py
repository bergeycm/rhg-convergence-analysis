...
# ========================================================================================
# --- Code to LiftOver PLINK SNP dataset
# --- Modified (very) slightly from original by Abecasis Lab
# --- Downloaded from here: http://genome.sph.umich.edu/wiki/LiftMap.py
# ========================================================================================

import sys, os

def usage():
    print("%s -m old.map -p old.ped -d old.dat " % sys.argv[0] )
    print("-o new.prefix -l liftover_path -c chainfile")
    print("lift old.map (optionally .ped and .dat) to new.prefix.map")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', dest='liftover_path', default="")
